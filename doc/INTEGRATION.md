...
```gradle
implementation 'com.github.vishalsharma-hovr:hovr_device_permissions:v1.2.5'
```
...
```ruby
pod 'HovrDevicePermissions', :git => 'https://github.com/vishalsharma-hovr/hovr_device_permissions.git', :tag => 'v1.2.5'
```
